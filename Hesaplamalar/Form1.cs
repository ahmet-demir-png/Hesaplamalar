    ...
    public partial class anasayfa : Form
    {
        ...
        private void hesapla_farkli()
        {
            ...
            if(durum_farkli_islem == 1)
            {
                ...
                listBox_Listececmisi.Items.Add("Dairenin Alanı: " + hsp.dairealan(sayi1));
            }
            if(durum_farkli_islem == 2)
            {
                label_a.Text = "Dairenin Yarı Çapını Giriniz:";
                label_b.Text = "Dairenin Çevresi: " + hsp.dairecevre(sayi1);
                listBox_Listececmisi.Items.Add("Dairenin Çevresi: " + hsp.dairecevre(sayi1));
            }
            if (durum_farkli_islem == 3)
            {
                ...
                listBox_Listececmisi.Items.Add("Dikdörtgenin Alanı: " + hsp.dikdortgenalan(sayi1, sayi2));
            }
            if (durum_farkli_islem == 4)
            {
                ...
                listBox_Listececmisi.Items.Add("Dikdörtgenin Çevresi: " + hsp.dikdortgencevre(sayi1, sayi2));
            ...
            if (durum_farkli_islem == 5)
            {
                ...
                listBox_Listececmisi.Items.Add("Karenin Alan: " + hsp.karealan(sayi1));
            }
            ...
            if(durum_farkli_islem == 7)
            {
                ...
                listBox_Listececmisi.Items.Add("Yol uzunluğu: " + hsp.yolhesaplama(sayi1, sayi2));
            }
